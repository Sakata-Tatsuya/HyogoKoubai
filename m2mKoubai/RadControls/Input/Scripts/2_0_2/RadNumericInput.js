...
return this.Move(this.Step,true);
},MoveDown:function(){
return this.Move(-this.Step,true);
...
var _1a=_19.getElementsByTagName("span");
var i;
for(i=0;i<_1a.length;i++){
if(_1a[i].className.indexOf("radSpinDownCss")!=(-1)){
this.SpinDownButton=_1a[i];
}else{
if(_1a[i].className.indexOf("radSpinUpCss")!=(-1)){
...
if(_2b<this.MinValue||_2b>this.MaxValue){
...
var _30=_2f;
var _2f=NumberFormat.Parse(_2f,this.RejectRegExp,this.NumberFormat.DecimalSeparator,this.NumberFormat.NegativeSign);
