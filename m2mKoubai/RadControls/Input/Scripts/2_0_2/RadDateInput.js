...
var _17=null;
if(this.CurrentIs("NUMBER")&&this.Tokens.length==1&&(this.CurrentToken().Value.length==6||this.CurrentToken().Value.length==8)){
...
var _b=/MSIE/.test(navigator.userAgent);
var _c=_b?e.keyCode:e.which;
if(_c==13){
this.CallBase("UpdateHiddenValueOnKeyPress",arguments);
}
},RaiseValueChangedEvent:function(_d,_e){
var _f=this.ValueChangedEventArgs(_d,_e);
var _10=_f.NewDate;
var _11=_f.OldDate;
if((!_10&&!_11)||(_10&&_11&&_10.toString()==_11.toString())){
return false;
}
this.InitialValue=this.GetValue();
var _12=this.RaiseEvent("OnValueChanged",_f);
if(this.AutoPostBack&&_12){
this.RaisePostBackEvent();
}
return _12;
},HandleWheel:function(_13){
var _14=(_13)?-this.Step:this.Step;
return this.Move(_14,false);
},Move:function(_15,_16){
if(this.IsReadOnly()){
return false;
}
var _17=this.ParseDate(this.TextBoxElement.value);
if(!_17){
return false;
}
var _18=this.GetRaplacedFormat(_17);
var _19=this.GetCurrentDatePart(_18);
switch(_19){
case "y":
_17.setFullYear(_17.getFullYear()+_15);
break;
case "M":
_17.setMonth(_17.getMonth()+_15);
break;
case "d":
_17.setDate(_17.getDate()+_15);
break;
case "h":
_17.setHours(_17.getHours()+_15);
break;
case "H":
_17.setHours(_17.getHours()+_15);
break;
case "m":
_17.setMinutes(_17.getMinutes()+_15);
break;
case "s":
_17.setSeconds(_17.getSeconds()+_15);
break;
default:
break;
}
if((this.GetMaxDate()<_17)||(this.GetMinDate()>_17)){
return false;
}
if(!_16){
this._SetValue(this.DateFormatInfo.FormatDate(_17,this.DateFormat));
}else{
this.SetValue(this.DateFormatInfo.FormatDate(_17,this.DateFormat));
}
var _1a=this.GetRaplacedFormat(_17);
this.SetCaretPosition(_1a.indexOf(_19));
return true;
},GetRaplacedFormat:function(_1b){
var _1c=this.DateFormat;
var _1d=new Array({"part":"y","value":_1b.getYear()},{"part":"M","value":_1b.getMonth()+1},{"part":"d","value":_1b.getDate()},{"part":"h","value":_1b.getHours()},{"part":"H","value":_1b.getHours()},{"part":"m","value":_1b.getMinutes()},{"part":"s","value":_1b.getSeconds()});
var i;
for(i=0;i<_1d.length;i++){
var p=_1d[i].part;
var _20=new RegExp(p,"g");
var _21=new RegExp(p);
var _22=new RegExp(p+p);
var _23=p+p;
if(_1c.match(_21)&&!_1c.match(_22)&&_1d[i].value.toString().length>1){
_1c=_1c.replace(_20,_23);
}
}
if(_1c.match(/MMMM/)){
var _24=this.DateTimeFormatInfo.MonthNames[this.GetDate().getMonth()];
var i;
var _23="";
for(i=0;i<_24.length;i++){
_23+="M";
}
_1c=_1c.replace(/MMMM/,_23);
}
if(_1c.match(/dddd/)){
...
_1c=_1c.replace(/dddd/,_23);
}
return _1c;
},GetCurrentDatePart:function(_26){
var _27="";
var _28="yhMdhHms";
while(((_28.indexOf(_27)==(-1))||_27=="")){
this.CalculateSelection();
_27=_26.substring(this.SelectionStart,this.SelectionStart+1);
this.SelectText(this.SelectionStart-1,this.SelectionEnd-1);
}
return _27;
},ValueChangedEventArgs:function(_29,_2a){
return {"NewValue":_29,"OldValue":_2a,"NewDate":this.ParseDate(_29),"OldDate":this.ParseDate(_2a)};
},ParseDate:function(_2b,_2c){
try{
var _2d=new Telerik.DateParsing.DateTimeLexer(this.DateFormatInfo);
var _2e=_2d.GetTokens(_2b);
var _2f=new Telerik.DateParsing.DateTimeParser(this.DateTimeFormatInfo.TimeInputOnly);
var _30=_2f.Parse(_2e);
_2c=this.GetParsingBaseDate(_2c);
var _31=_30.Evaluate(_2c,this.DateFormatInfo);
return _31;
}
catch(parseError){
...
},GetParsingBaseDate:function(_32){
var _33=_32;
if(_33==null){
_33=new Date();
}
if(!this.DateInRange(_33)){
_33=this.GetMinDate();
}
_33.setHours(0,0,0,0);
return _33;
},GetFormattedValue:function(_34,_35){
if(_34!=""){
var _36=this.ParseDate(_34);
_36=(_36>this.GetMaxDate())?this.GetMaxDate():_36;
_36=(_36<this.GetMinDate())?this.GetMinDate():_36;
_34=this.DateFormatInfo.FormatDate(_36,_35);
}
return _34;
},GetMaxDate:function(){
return this.MaxDate;
...
return this.MinDate;
},SetDate:function(_37){
this.SetValue(this.DateFormatInfo.FormatDate(_37,this.DateFormat));
},GetDate:function(_38){
var _39=this.CloneDate(this.HiddenElement.value);
return _39;
},SetMaxDate:function(_3a){
return this.MaxDate;
},SetMinDate:function(_3b){
this.MinDate=_3b;
},CloneDate:function(_3c){
if(!_3c){
return null;
}
...
return _3d;
},SetHiddenValue:function(_3e){
this.HoldsValidDateValue=true;
var _3f="";
if(_3e!=""){
var _40=this.ParseDate(_3e);
if(_40==null){
var _41={Reason:RadInputErrorReason.ParseError,InputText:_3e};
_40=this.ResolveDateError(_41,null);
}
if(_40==null){
return this.Invalidate();
}
if(!this.DateInRange(_40)){
var _41={Reason:RadInputErrorReason.OutOfRange,InputText:_3e};
_40=this.ResolveDateError(_41,_40);
}
if(!this.DateInRange(_40)){
return this.Invalidate();
}
_3f=this.DateFormatInfo.FormatDate(_40,this.hiddenFormat);
}
return this.CallBase("SetHiddenValue",[_3f]);
},Invalidate:function(){
this.HoldsValidDateValue=false;
this.CallBase("ClearHiddenValue",[]);
return false;
},ResolveDateError:function(_42,_43){
var _44=this.GetDate();
this.RaiseErrorEvent(_42);
var _45=this.GetDate();
if(_45-_44!=0){
return _45;
}else{
return _43;
}
},DateInRange:function(_46){
return (this.CompareDates(_46,this.GetMinDate())>=0)&&(this.CompareDates(_46,this.GetMaxDate())<=0);
},CompareDates:function(_47,_48){
return _47-_48;
},GetDisplayValue:function(){
var _49=this.CloneDate(this.HiddenElement.value);
return this.DateFormatInfo.FormatDate(_49,this.DisplayDateFormat);
},GetEditValue:function(){
var _4a=this.CloneDate(this.HiddenElement.value);
return this.DateFormatInfo.FormatDate(_4a,this.DateFormat);
