...
if((_18==13)&&(this.TextBoxElement.tagName.toUpperCase()!="TEXTAREA")){
this.Blur();
return true;
}
},UpdateHiddenValueOnKeyPress:function(){
this.UpdateHiddenValue();
},AttachToTextBoxEvent:function(_19,_1a){
this.AttachDomEvent(this.TextBoxElement,_19,_1a);
...
this.RaiseValueChangedEvent(_25,this.InitialValue);
if(typeof (_26)=="undefined"||_26==true){
this.SetTextBoxValue(this.GetEditValue());
this.UpdateDisplayValue();
this.UpdateCssClass();
}
},TriggerDOMChangeEvent:function(_27){
if(_27.fireEvent){
var _28=document.createEventObject();
_27.fireEvent("onchange",_28);
}else{
if(_27.dispatchEvent){
var _29=true;
var _28=document.createEvent("HTMLEvents");
_28.initEvent("change",_29,true);
_27.dispatchEvent(_28);
}
}
},_SetValue:function(_2a){
var _2b=this.SetHiddenValue(_2a);
if(typeof (_2b)=="undefined"||_2b==true){
this.SetTextBoxValue(this.GetEditValue());
}
},RaiseValueChangedEvent:function(_2c,_2d){
if(_2c.toString()==_2d.toString()){
return false;
}
this.InitialValue=this.GetValue();
var _2e=this.RaiseEvent("OnValueChanged",this.ValueChangedEventArgs(_2c,_2d));
if(this.AutoPostBack&&_2e){
this.RaisePostBackEvent();
}
return _2e;
},Clear:function(){
this.SetValue("");
},SetTextBoxValue:function(_2f){
if(this.TextBoxElement.value!=_2f){
this.TextBoxElement.value=_2f;
}
},GetTextBoxValue:function(_30){
...
},RaiseErrorEvent:function(_31){
if(this.InEventRaise){
return;
}
this.InEventRaise=true;
var _32=this.RaiseEvent("OnError",_31);
if(_32!=false){
this.Invalid=true;
this.UpdateCssClass();
var _33=this;
...
var _37=s.text.length;
var _38=s.text.length+s1.text.length;
this.SelectionEnd=Math.max(_37,_38);
this.SelectionStart=Math.min(_37,_38);
...
sel.select();
},SelectText:function(_39,end){
this.SelectionStart=_39;
...
return false;
},SetCaretPosition:function(_3b){
this.SelectionStart=_3b;
this.SelectionEnd=_3b;
this.ApplySelection();
},UpdateHiddenValue:function(){
return this.SetHiddenValue(this.TextBoxElement.value);
},InitializeButtons:function(){
this.Button=null;
var _3c=document.getElementById(this.WrapperElementID);
var _3d=_3c.getElementsByTagName("span");
for(i=0;i<_3d.length;i++){
if(_3d[i].className.indexOf("radInpButtonCss")!=(-1)){
this.Button=_3d[i];
this.AttachDomEvent(this.Button,"click","ButtonClickHandler");
}
}
},ButtonClickHandler:function(e){
var _3f={"ButtonName":"Button"};
this.RaiseEvent("OnButtonClick",_3f);
},SetHiddenValue:function(_40){
if(this.HiddenElement.value!=_40.toString()){
this.HiddenElement.value=_40;
}
this.SetValidationField(_40);
return true;
},SetValidationField:function(_41){
},GetValidationField:function(){
return this.HiddenElement;
},ClearHiddenValue:function(){
this.HiddenElement.value="";
},ValueChangedEventArgs:function(_42,_43){
if(_43==null){
_43=this.HiddenElement.value;
}
return {"NewValue":_42,"OldValue":_43};
},GetValue:function(){
...
RadControlsNamespace.AppendStyleSheet=function(_44,_45,_46){
if(!_46){
return;
}
var _47=window.netscape&&!window.opera;
if(!_44&&_47){
document.write("<"+"link"+" rel='stylesheet' type='text/css' href='"+_46+"' />");
}else{
var _48=document.createElement("link");
_48.rel="stylesheet";
_48.type="text/css";
_48.href=_46;
document.getElementsByTagName("head")[0].appendChild(_48);
}
};
...
var _4a=document.createTextNode((new Date().toString())+": "+msg);
this.logElement.appendChild(_4a);
