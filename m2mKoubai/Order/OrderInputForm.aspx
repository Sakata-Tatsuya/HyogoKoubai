...
<head>
    ...
    <script type="text/javascript">
        ...
        //function ShiireChange(rowNo) {
        //    $('HidArgs').value = rowNo;
        //    var meisai = CreateMeisai(false, false);
        //    AjaxRequest('ShiireChange', rowNo);
        //}
        ...
        */
        ...
        function CreateMeisai(bSakujo, bTouroku)
        {
            ...
            for (var i = 1; i < grid.rows.length; i++) {
                ...
                var shiireCode = ddlShiire.value;

                var cel0 = grid.rows.item(i).cells.item(2).children;
                var tbl0 = cel0.item(0);

                //var ddlKubun = tbl0.rows.item(0).cells.item(0);
                ...
                if (ddlKubun.length > 0 && ddlKubun.selectedIndex > 0)
                {
                    ...
                    buhinKubun = ddlKubun.value;
                }
                //console.log(buhinKubun);
	            //var ddlBuhin = tbl0.rows.item(1).cells.item(0).firstChild;
                var ddlBuhin = tbl0.rows.item(1).cells.item(0).firstChild.nextSibling;
                //console.log(ddlBuhin);
                var buhinCode = '';
                if (ddlBuhin.length > 0 && ddlBuhin.selectedIndex > 0)
                {
                    //buhinCode = ddlBuhin.options[ddlBuhin.selectedIndex].value;
                    buhinCode = ddlBuhin.value;
                }
                //console.log(buhinCode);
                ...
                var lblLot = tbl1.rows.item(0).cells.item(0).firstChild.nextSibling;
                //console.log(lblLot);
                                    ...
                                    <tr>
                                        <td class="tc s3 hei25">
                                            <radCln:RadDatePicker ID="RdpNouki" runat="server">
                                                <DateInput Width="80px" Font-Size="11pt">
                                                </DateInput>
