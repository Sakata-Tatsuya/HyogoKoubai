...
<head>
  ...
  function $(id)
        ...
        {               
           var win = window.open
            ("ShiiresakiAccountUpForm.aspx?key="+key,"_brank","width=550px,height=400px,location=no,resizable=yes,scrollbars=yes");            			        
	        win.focus();	
        }  
    	function Shinki()
		{			    			    	      		    
		   var win = window.open
            ("ShiiresakiAccountUpForm.aspx","_brank","width=550px,height=400px,location=no,resizable=yes,scrollbars=yes");            
		    win.focus();	
		}   			  
		function Delete()
        {          
