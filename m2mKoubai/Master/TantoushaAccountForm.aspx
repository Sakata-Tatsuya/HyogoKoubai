<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TantoushaAccountForm.aspx.cs" Inherits="m2mKoubai.Master.TantoushaAccountForm" %>
...
<head>
    ...
    <link href="../MainStyle.css" rel="stylesheet" type="text/css" />
       <script type="text/javascript">
        ...
        {               
            var win = window.open
            ("TantoushaAccountUpForm.aspx?key="+key,"_brank","width=600px,height=380px,location=no,resizable=yes,scrollbars=yes");            			        
	        win.focus();	
        }  
    	function Shinki()
		{			    			    	      		    
		    var win = window.open
            ("TantoushaAccountUpForm.aspx","_brank","width=600px,height=380px,location=no,resizable=yes,scrollbars=yes");            
		    win.focus();	
		}   			  
		function Delete()
        {          
        ...
        <table border="1" bordercolor="#000000" class="def9 bg1 col mt5 tc">
            <tr class="bg15 tc">
                <td style="height: 15px" class="bg3">
                    担当者</td>
                <td class="bg3" style="height: 15px">
                    事業所</td>
                <td rowspan="2">
            ...
            <tr class="tc">
                <td>
                    <asp:DropDownList ID="DdlTCode" runat="server">
                    </asp:DropDownList></td>
                <td>
                    <asp:DropDownList ID="DdlJigyousho" runat="server">
                    </asp:DropDownList></td>
            </tr>
        </table>
        ...
        <table width="100%" id="TblList" runat="server" class="def9">
            ...
            <tr>
                <td>
                    ...
                    <asp:GridView ID="G" runat="server" AutoGenerateColumns="False" Width="100%" OnRowDataBound="G_RowDataBound" >
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="管理者権限">
                                <ItemStyle CssClass="tc" />
                            </asp:BoundField>
                        </Columns>
