	...
	function OnResponseEnd(sender, args)
    {
        ...
        switch(cmd)
        {
            ...
            case "nyuryoku_close":
                ...
                var hid_current_array = $('TbxKaitouNouki').value.split("\t"); 
                var hid_current_array2 = $('TbxShiteiNouki').value.split("\t"); 
...
　　
      function GetIndex(cn)
	   ...
	   {	  
	         return Core_GetDataArray(key,$('HidDataKey'), $('HidData'), ',', ':', true);
	   }
	    function GetDataArray2(key)
	    {	 	       
		    return Core_GetDataArray(key, $('HidDataKey'), $('HidData'),',', ':', false);
	    }	
	    ...
	    function NKC_REG(cnjk_arg)
	    {
	        ...
	        for(var i = 0; i < nkd_array.length; i++)
	        {
	            ...
	            var nk = $(kaitou_nouki_data[1]);
	            var suu = $(kaitou_nouki_data[2]);
	            var ktno = $(kaitou_nouki_data[3]);
	            ...
	            {
	                var n = $(nk_vals[t]).value;
	                var s = $(suu_vals[t]).value;
    ...
    function NKM_Sum(_suu, tbx_sum)
	{
	    ...
	    $(tbx_sum).value = (0 >= dSum)? "" : Shousuu2keta(dSum);
	}
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <HeaderTemplate>
                                    納品書<br />
                                    印刷<br />
                                    <input id="ChkH_N" runat="server" type="checkbox" />
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <input id="ChkN" runat="server" type="checkbox" />
                                </ItemTemplate>
                                <ItemStyle CssClass="tc" />
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <HeaderTemplate>
                                    現品票<br />
                                    印刷<br />
                                    <input id="ChkH_G" runat="server" type="checkbox" />
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <input id="ChkG" runat="server" type="checkbox" />
                                </ItemTemplate>
                                <ItemStyle CssClass="tc" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <table class=" col" frame="void" width="100%">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Literal ID="LitHacchuuTantoushaMei" runat="server"></asp:Literal></td>
                                        </tr>
                                    </table>
                                </ItemTemplate>
                            </asp:TemplateField>
