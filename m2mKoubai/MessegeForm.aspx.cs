...
namespace m2mKoubai
{
    public partial class MessegeForm : System.Web.UI.Page
    {
        ...
        // MsgRow作成
        private m2mKoubaiDataSet.T_ChumonMsgRow CreateRow()
        {
            m2mKoubaiDataSet.T_ChumonMsgRow dr = ChumonMsgClass.newT_ChumonMsgRow();
            // 主キー
            dr.Year = VsYear;
        ...
        protected void BtnReg_Click(object sender, EventArgs e)
        {
            ...
            {
                // 新規登録
                m2mKoubaiDataSet.T_ChumonMsgRow drNew = this.CreateRow();
