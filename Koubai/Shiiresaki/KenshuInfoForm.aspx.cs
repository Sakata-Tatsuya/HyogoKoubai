    ...
    public partial class KenshuInfoForm : System.Web.UI.Page
    {
        ...
        protected void OutputInvoice()
        {
            ...
            if (dt != null) 
            {
                ...
                string strFileName = @"請求書" + strInvoiceID + "_" + DateTime.Now.ToString("yyyyMMddhhmmss") + ".pdf";
        ...
        protected void OutputAcceptance()
        {
            ...
            if (dt != null)
            {
                ...
                string strFileName = @"検収明細書" + strAcceptanceID + "_" + DateTime.Now.ToString("yyyyMMddhhmmss") + ".pdf";
                string path = @"c:\temp\Koubai\" + strFileName;
                DateTime dtTourokuBi = DateTime.Now;
                DateTime dtInsatuBi = DateTime.Now;
                DateTime dtSoshinBi = DateTime.MinValue;
