<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtlNoukiKaitou.ascx.cs" Inherits="Koubai.Shiiresaki.CtlNoukiKaitou" %>
<table runat="server" id="T" border="0" cellpadding="2" cellspacing="0" bordercolor="#000000" class="col" frame="void" >
    ...
    <tr  >
        <td  nowrap="nowrap">
            <asp:Button ID="BtnTouroku" runat="server" Text="“o˜^" CssClass="f8" Font-Size="8pt" />
