...
namespace Koubai.Shiiresaki
{
    public partial class OrderInfoForm : System.Web.UI.Page
    {
        ...
        KoubaiDataSet.T_NoukiKaitouDataTable m_dtKaitouNouki = null;
                ...
                case "nyuryoku_open":
                    ...
                    for (int i = 0; i < strChumonKeyArray.Length; i++)
                    {
                        ...
                        if (!dr.IsHenkouNoNull())
                        {
                            ...
                            KoubaiDataSet.T_NoukiHenkouDataTable dtNouki =
                        ...
                        // 最新の回答Noの
                        KoubaiDataSet.T_NoukiKaitouDataTable dt = NoukiKaitouClass.getT_NoukiKaitouDataTable(strYear, strHacchuuNo, nKubun, nKaitouNo, Global.GetConnection());
        ...
        {
            // 仕入先情報を取得
            KoubaiDataSet.M_ShiiresakiRow drShiire =
        ...
        protected void OutputDelivery()
        {
            ...
            if (dt != null)
            {
                ...
                string strFileName = @"納品書" + strSlipID + "_" + dtNengappi.ToString("yyyyMMddhhmmss") + ".pdf";
                string path = @"c:\temp\Koubai\" + strFileName;
                DateTime dtTourokuBi = DateTime.Now;
                DateTime dtInsatuBi = DateTime.Now;
                DateTime dtSoshinBi = DateTime.MinValue;
        ...
        protected void OutputItemTag()
        {
            ...
            if (dt != null)
            {
                ...
                string strFileName = @"現品票" + strSlipID + "_" + dtNengappi.ToString("yyyyMMddhhmmss") + ".pdf";
                string path = @"c:\temp\Koubai\" + strFileName;
                DateTime dtTourokuBi = DateTime.Now;
                DateTime dtInsatuBi = DateTime.Now;
                DateTime dtSoshinBi = DateTime.MinValue;
