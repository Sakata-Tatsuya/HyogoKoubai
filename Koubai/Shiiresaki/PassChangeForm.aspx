<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PassChangeForm.aspx.cs" Inherits="Koubai.Shiiresaki.PassChangeForm" %>
...
<%--        <uc1:CtlTabShiire ID="Tab" runat="server" />--%>
        ...
        <table align="left" id="TblList" runat="server" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td class="tc" >
                    <input id="BtnT" runat="server" type="button" value="変更登録" class="mt20 bg98" />
                </td>
            </tr>
        </table>
