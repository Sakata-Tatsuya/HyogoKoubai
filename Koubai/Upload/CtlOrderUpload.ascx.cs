...
namespace Koubai.Upload
{
    public partial class CtlOrderUpload : System.Web.UI.UserControl
    {
        ...
        protected void BtnUpload_Click(object sender, EventArgs e)
        {
            ...
            KoubaiDataSet.M_BuhinDataTable dtBuhin = BuhinClass.getM_BuhinDataTable(Global.GetConnection());
            DataView dvBuhin = dtBuhin.DefaultView;

            KoubaiDataSet.M_NounyuuBashoDataTable dtNounyuuBasho = NounyuuBashoClass.getM_NounyuuBashoDataTable(Global.GetConnection());
