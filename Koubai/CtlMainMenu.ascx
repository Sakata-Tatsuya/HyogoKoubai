<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtlMainMenu.ascx.cs" Inherits="Koubai.CtlMainMenu" %>
...
<table id="T0" runat="server" border="0" cellpadding="0" cellspacing="0" style="margin-top: 2px; margin-bottom: 1px;">
    <tr>
        <td nowrap="nowrap">
            <asp:Label ID="LblSiteMei" runat="server" CssClass="def" Font-Bold="True" Font-Names="メイリオ" Font-Size="16pt" ForeColor="Green" Text="Web-EDI">
            </asp:Label>
        </td>
        <td width="20px">
            <p>　</p>
