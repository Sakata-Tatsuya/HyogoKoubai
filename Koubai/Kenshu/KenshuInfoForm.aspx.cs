...
namespace Koubai.Kenshu
{
    public partial class KenshuInfoForm : System.Web.UI.Page
    {
       ...
       // private const int G_CELL_I = 0;
        ...
        private const int G_CELL_SHIIRE_NAME = 2;
        private const int G_CELL_BUHIN_KUBUN = 3;
        private const int G_CELL_BUHIN_CODE = 4;
        private const int G_CELL_BUHIN_NAME = 5;
        private const int G_CELL_CHUMON_SUURYOU = 6;
        private const int G_CELL_TANI = 7;
        private const int G_CELL_TANKA = 8;
        private const int G_CELL_CHUMON_KINGAKU = 9;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                tab.KenshuMenu = CtlTabMain.Kenshu_Jyouhou.Yichiran;
        ...
        protected void Ram_AjaxRequest(object sender, Telerik.Web.UI.AjaxRequestEventArgs e)
        {
            ...
            switch (strCmd)
            {
                ...
                case "reload":
                    ...
                    break;
                case "ddlBuhin":
                    ListSet.SetDdlBuhin_K(this.DdlBuhinKubun.SelectedValue, this.DdlBuhin);
           ...
           if (e.Row.RowType == DataControlRowType.DataRow)
            {
               ...
               // decimal Kingaku = Math.Floor(dr.Suuryou * dr.Tanka);
                e.Row.Cells[G_CELL_CHUMON_KINGAKU].Text = "\\" + dr.Kingaku.ToString("#,##0");
                // 納入場所
