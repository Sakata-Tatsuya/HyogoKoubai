...
namespace Koubai.Master
{
    public partial class BuhinUpForm : System.Web.UI.Page
    {
        ...
        */
        ...
        // Row作成
        private KoubaiDataSet.M_BuhinRow CreateRow(bool bShinki)
        {
            KoubaiDataSet.M_BuhinRow dr = BuhinClass.newM_BuhinRow();
        ...
        // 新規登録重複チェック
        private bool TourokuCheck(KoubaiDataSet.M_BuhinRow dr)
        {
            // データ重複チェック
            KoubaiDataSet.M_BuhinRow drChk = BuhinClass.getM_BuhinRow(dr.BuhinCode, Global.GetConnection());
            if (drChk != null)
            {
        ...
        {
            KoubaiDataSet.M_BuhinRow dr = this.CreateRow(true);
            if (dr == null)
                return;
            if (!TourokuCheck(dr))
                return;
        ...
        {
            KoubaiDataSet.M_BuhinRow dr1 = this.CreateRow(false);
            if (dr1 == null)
                return;
