<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShiiresakiForm.aspx.cs" Inherits="Koubai.Master.ShiiresakiForm" %>
...
<script language="javascript" type="text/javascript">
        ...
        {
            var win = window.open
            ("ShiiresakiUpForm?key="+key,"_brank","width=550px,height=500px,location=no,resizable=yes,scrollbars=yes");
            win.focus();
        }
        function Shinki()
        {
            var win = window.open
            ("ShiiresakiUpForm","_brank","width=550px,height=500px,location=no,resizable=yes,scrollbars=yes");
            win.focus();
        }
        function Delete()
        {
