...
namespace Koubai.Master
{
    public partial class KaishaInfoForm : System.Web.UI.Page
    {
        ...
        private void Create()
        {
            ...
            KoubaiDataSet.T_KaishaInfoDataTable dt = KaishaInfoClass.getT_KaishaInfoDataTable(this.GetKensakuParam(), Global.GetConnection());
        ...
        protected void G_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                // 担当者の件数
                KoubaiDataSet.T_KaishaInfoRow dr = ((DataRowView)e.Row.DataItem).Row as KoubaiDataSet.T_KaishaInfoRow;
