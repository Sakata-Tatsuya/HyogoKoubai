...
namespace Koubai.Master
{
    public partial class ShiiresakiUpForm : System.Web.UI.Page
    {
        ...
        private void CreateKoushin()
        {
            ...
            KoubaiDataSet.M_ShiiresakiRow drShiiresaki =
        ...
        private KoubaiDataSet.M_ShiiresakiRow CreateRow(bool b)
        {
            KoubaiDataSet.M_ShiiresakiRow dr = ShiiresakiClass.newM_ShiiresakiRow();
        ...
        // 新規登録重複チェック
        private bool TourokuCheck(KoubaiDataSet.M_ShiiresakiRow dr)
        {
            // データ重複チェック
            KoubaiDataSet.M_ShiiresakiRow drChk =
        ...
        {
            KoubaiDataSet.M_ShiiresakiRow dr = this.CreateRow(true);
            if (dr == null)
                return;
            if (!TourokuCheck(dr))
                return;
        ...
        {
            KoubaiDataSet.M_ShiiresakiRow dr1 = this.CreateRow(false);
            if (dr1 == null)
                return;
