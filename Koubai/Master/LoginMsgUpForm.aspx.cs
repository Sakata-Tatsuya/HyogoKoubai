...
namespace Koubai.Master
{
    public partial class LoginMsgUpForm : System.Web.UI.Page
    {
        ...
        {
            KoubaiDataSet.M_LoginMsgRow dr =
        ...
        // Row作成
        private KoubaiDataSet.M_LoginMsgRow CreateRow(bool bSinki)
        {
            KoubaiDataSet.M_LoginMsgRow dr = LoginMsgClass.newM_LoginMsgRow();
            if (bSinki)
            {
                // 新規時                
                // 登録日
        ...
        {
            KoubaiDataSet.M_LoginMsgRow dr = this.CreateRow(true);
            if (dr == null)
                return;
        ...
        {
            KoubaiDataSet.M_LoginMsgRow dr1 = this.CreateRow(false);
            if (dr1 == null)
                return;
