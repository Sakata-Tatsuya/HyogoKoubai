...
namespace Koubai
{
    public class ListSet
    {
        ...
        public static void SetDdlJigyoushoKubun(byte bKubun, DropDownList ddl)
        {
            ddl.Items.Clear();
            ddl.Items.Add(new ListItem("---", "0"));
            KoubaiDataSet.T_KaishaInfoDataTable dt =
        ...
        public static void SetDdlBuhin(DropDownList ddl)
        {
            ...
            KoubaiDataSet.M_BuhinDataTable dt =
        ...
        public static void SetDdlTantousha(byte bKubun, DropDownList ddl)
        {
            ddl.Items.Clear();
            ddl.Items.Add(new ListItem("---", "0"));
            KoubaiDataSet.M_LoginDataTable dt =
        ...
        public static void SetDdlShiiresaki(DropDownList ddl)
        {
            ddl.Items.Clear();
            ddl.Items.Add(new ListItem("---", "0"));
            KoubaiDataSet.M_ShiiresakiDataTable dt =
        ...
        public static void SetDdlNounyuuBasho(DropDownList ddl)
        {
            ...
            KoubaiDataSet.M_NounyuuBashoDataTable dt =
        ...
        public static void SetDdlHacchuuNo(string strYear, DropDownList ddl)
        {
            ...
            KoubaiDataSet.T_ChumonDataTable dt = ChumonClass.getT_ChumonDataTableByYear(strYear, 0,Global.GetConnection());
            for (int i = 0; i < dt.Rows.Count; i++)
            {
