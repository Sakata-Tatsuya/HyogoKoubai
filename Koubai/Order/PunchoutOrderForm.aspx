<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PunchoutOrderForm.aspx.cs" Inherits="Koubai.Order.PunchoutOrderForm" %>
            ...
            <tr>
                <td>
                    <table class="col tc" bordercolor="#000000" border="1" frame="box">
                        <tbody>
                            <tr>
                                <td colspan= "2" class ="bg3 b f10">カタログサイト </td>
                            </tr>
                            <tr>
                                <td class="bg8">
                                    <asp:DropDownList id="DdlShiiresaki" runat="server" AutoPostBack="True" onselectedindexchanged="DdlShiiresaki_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </td>
                                <td style="padding:0 0 0 0">
                                    <asp:Button ID="BtnPOut" runat="server" Text="カタログサイトを表示する" OnClick="BtnPOut_Click" />
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <asp:GridView ID="G" runat="server" AutoGenerateColumns="False" Width="100%" CssClass="def9" OnRowDataBound="G_RowDataBound">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="発注No">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate><table align="center" class="col" frame="void" width="100%">
                                    <tr>
                                        <td class="nw s3">
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <table align="center" class="col" frame="void" width="100%">
                                        <tr>
                                            <td class="tr nw hei25 s3">
                                    <asp:Label ID="LblLot" runat="server" CssClass="def12"></asp:Label></td>
                                        </tr>
                                        <tr>
                                            <td class="tr nw">
