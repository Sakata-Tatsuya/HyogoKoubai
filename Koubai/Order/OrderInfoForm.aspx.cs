...
namespace Koubai.Order
{
    public partial class OrderInfoForm : System.Web.UI.Page
    {
        ...
        KoubaiDataSet.T_NoukiHenkouDataTable m_dtNoukiHenkou = null;

        DataView m_dvNoukiKaitou = null;
        KoubaiDataSet.T_NoukiKaitouDataTable m_dtNoukiKaitou = null;
        ...
        protected void G_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                // 最新の変更納期
                LblNouki.Text = infoNoki.strNoukiHenkouHtml;
                ...
                if (!dr.IsKaitouNoNull() && dr.KaitouNo>0)
                {
                    int nSuuryou = 0;
                    bool b = false;
                    KoubaiDataSet.T_NoukiKaitouDataTable dtKaitou = NoukiKaitouClass.getT_NoukiKaitouDataTable(dr.Year, dr.HacchuuNo, dr.JigyoushoKubun, dr.KaitouNo, Global.GetConnection());
                ...
                {
                    KoubaiDataSet.T_NouhinDataTable dt = NouhinClass.getT_NouhinDataTable(dr.Year, dr.HacchuuNo, dr.JigyoushoKubun, Global.GetConnection());
                    string strNouhinbi = "";
            ...
            switch (strCmd)
            {
                ...
                case "nyuryoku_open":
                    ...
                    for (int i = 0; i < strChumonKeyArray.Length; i++)
                    {
                        ...
                        KoubaiDataSet.T_NoukiHenkouDataTable dt =
                ...
                case "nouki_kaitou_reg":
                    ...
                    for (int i = 0; i < strChumonKeyArray.Length; i++)
                    {
                        ...
                        // 最新の回答Noと行数取得
                        // 最新の回答No取得
                        ChumonDataSet.V_Chumon_JyouhouRow drChuumon = ChumonClass.getV_Chumon_JyouhouRow(strYear, strHacchuuNo, nKubun, Global.GetConnection());
        ...
        protected void BtnHP_Click(object sender, EventArgs e)
        {
            ...
            {
                HtmlInputCheckBox ChkI = G.Rows[i].FindControl("ChkI") as HtmlInputCheckBox;
                if (ChkI.Checked)
                {
        ...
        protected void OutputOrder()
        {
            ...
            if (dt != null)
            {
                ...
                string strSlipID = @"ODR" + dt[0].ShiiresakiCode + "_" + dt[0].HacchuuNo;
                string strFileName = @"発注書" + strSlipID + "_" + dtNengappi.ToString("yyyyMMddhhmmss") + ".pdf";
                string path = @"c:\temp\Koubai\" + strFileName;
