...
{
    public partial class PunchoutOrderForm : System.Web.UI.Page
    {
        ...
        protected void G_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (mi.strBuhinCode != string.Empty)
                {
                    ...
                    KoubaiDataSet.M_BuhinRow drM = BuhinClass.getM_BuhinRow(mi.strBuhinCode, Global.GetConnection());
                    if (drM != null)
                    {
        ...
        private void LoadDdlBasho(string strKey, DropDownList ddl)
        {
            ...
            KoubaiDataSet.M_NounyuuBashoDataTable dt = NounyuuBashoClass.getM_NounyuuBashoDataTable(Global.GetConnection());
        ...
        protected void RcbBuhin_ItemsRequested(object o, RadComboBoxItemsRequestedEventArgs e)
        {
            ...
            int nTotal = 0;
            KoubaiDataSet.M_BuhinDataTable dt = null;
