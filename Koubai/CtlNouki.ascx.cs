...
namespace Koubai
{
    public partial class CtlNouki : System.Web.UI.UserControl
    {
        ...
        public void Create(NoukiHenkouDataSet.HenkouNoukiDataTable dt, bool isNoData)
        {
            ...
            for (int i = 0; i < G.Rows.Count; i++)
            {
                ...
                tbxKaitouNo.Text = dt[i].HenkouNo;
                tbxKaitouNo.Style["display"] = "none";
            }
            SetSum();
        }
        ...
        // 空行を追加
        private NoukiHenkouDataSet.HenkouNoukiDataTable
            insertNewBrankRow(NoukiHenkouDataSet.HenkouNoukiDataTable dt)
        {
            NoukiHenkouDataSet.HenkouNoukiDataTable dtNew = dt;

            NoukiHenkouDataSet.HenkouNoukiRow drNew = dtNew.NewHenkouNoukiRow();
