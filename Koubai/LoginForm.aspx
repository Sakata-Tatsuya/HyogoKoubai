<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginForm.aspx.cs" Inherits="Koubai.LoginForm" %>
<!DOCTYPE html>
...
<body onload="Load();" class="bg0">
    <form id="form1" runat="server">
        <table align="center" class="mt60" cellpadding="0" cellspacing="0">
            <tr>
                <td class="f35" >
                    <font color="#ff3333" style="font-family: 'Times New Roman'"><b>電子発注 Web-EDI</b></font></td>
            </tr>
            <tr>
                <td class="tc">
