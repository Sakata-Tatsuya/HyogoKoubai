...
namespace m2mKoubaiDAL
{
    ...
    public class HonyakuClass
    {
        ...
        public class HonyakuManager
        {
            ...
            m2mKoubaiDataSet.M_HonyakuDataTable _dt = null;
            ...
            public void Update(string strOriginal, SqlConnection sqlConn)
            {
                ...
                m2mKoubaiDataSet.M_HonyakuRow dr = this._dt.FindByOriginal(strOriginal);
                m2mKoubaiDataSet.M_HonyakuRow d = HonyakuClass.getM_HonyakuRow(strOriginal, sqlConn);
                if (null != dr && null != d)
                {
            ...
            public string GetString(string strOriginal, string strLanguageCode)
            {
                ...
                m2mKoubaiDataSet.M_HonyakuRow d = this._dt.FindByOriginal(strOriginal);
                if (null != d)
                {
                ...
                {
                    // なければ新規登録
                    m2mKoubaiDataSet.M_HonyakuRow dr = this._dt.NewM_HonyakuRow();
        ...
        public static m2mKoubaiDataSet.M_HonyakuDataTable
            getM_HonyakuDataTable(SqlConnection sqlConn)
        {
            SqlDataAdapter da = new SqlDataAdapter("", sqlConn);
            da.SelectCommand.CommandText = "SELECT * FROM M_Honyaku";
            m2mKoubaiDataSet.M_HonyakuDataTable dt = new m2mKoubaiDataSet.M_HonyakuDataTable();
            da.Fill(dt);
            return dt;
        }

        public static m2mKoubaiDataSet.M_HonyakuRow
        ...
        public static Core.Error
            Insert(m2mKoubaiDataSet.M_HonyakuRow dr, SqlConnection sqlConn)
        {
            SqlDataAdapter da = new SqlDataAdapter("", sqlConn);
        ...
        public static Core.Error Update(string strOriginal, string strChina, string strEn, SqlConnection sqlConn)
        {
            ...
            m2mKoubaiDataSet.M_HonyakuRow drThis = (m2mKoubaiDataSet.M_HonyakuRow)dt.Rows[0];
            try
            {
                //drThis.ja = dr.ja;
                drThis.zh = strChina;
        ...
        public static Core.Error SetM_Honyaku(HonyakuKey[] array, string strTourokuUserID, SqlConnection sqlConn)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < array.Length; i++)
                {
                    ...
                    dt.Clear();
                    da.Fill(dt);
                    m2mKoubaiDataSet.M_HonyakuRow dr = null;
