...
namespace KoubaiDAL
{
    public class BuhinClass
    {
        ...
        /// <param name="sqlConn"></param>
        /// <returns></returns>
        public static KoubaiDataSet.M_BuhinDataTable getM_BuhinDataTable(SqlConnection sqlConn)
        {
            SqlDataAdapter da = new SqlDataAdapter("", sqlConn);
        ...
        /// <param name="sqlConn"></param>
        /// <returns></returns>
        public static KoubaiDataSet.M_BuhinRow getM_BuhinRow(string BuhinCode, SqlConnection sqlConn)
        {
            SqlDataAdapter da = new SqlDataAdapter("", sqlConn);
            ...
            da.Fill(dt);
            if (1 == dt.Rows.Count)
                return (KoubaiDataSet.M_BuhinRow)dt.Rows[0];
            else
                return null;
        }
        ...
        /// <param name="sqlConn"></param>
        /// <returns></returns>
        public static LibError M_Buhin_Insert(KoubaiDataSet.M_BuhinRow dr, SqlConnection sqlConn)
        {
            SqlDataAdapter da = new SqlDataAdapter("", sqlConn);
            da.SelectCommand.CommandText = "SELECT * FROM M_Buhin";
            da.InsertCommand = (new SqlCommandBuilder(da)).GetInsertCommand();
            KoubaiDataSet.M_BuhinDataTable dt = new KoubaiDataSet.M_BuhinDataTable();
            KoubaiDataSet.M_BuhinRow drNew = dt.NewM_BuhinRow();
            try
            {
        ...
        /// <param name="sqlConn"></param>
        /// <returns></returns>
        public static LibError M_Buhin_Update(string BuhinCode, KoubaiDataSet.M_BuhinRow dr, SqlConnection sqlConn)
        {
            SqlDataAdapter da = new SqlDataAdapter("", sqlConn);
            da.SelectCommand.CommandText = "SELECT * FROM M_Buhin WHERE BuhinCode = @BuhinCode";
            //da.SelectCommand.Parameters.AddWithValue("@BuhinKubun", BuhinKubun);
            ...
            try
            {
                KoubaiDataSet.M_BuhinRow drThis = (KoubaiDataSet.M_BuhinRow)dt.Rows[0];
        ...
        /// </summary>
        /// <returns></returns>
        public static KoubaiDataSet.M_BuhinRow newM_BuhinRow()
        {
            return new KoubaiDataSet.M_BuhinDataTable().NewM_BuhinRow();
        }
        public static void getM_BuhinDataTable(string strText, string strShiiresakiCode, string strBuhinKubun, bool bFirstMatch, int nStartIndex, int nCount,
            SqlConnection sqlConn, out KoubaiDataSet.M_BuhinDataTable dt, ref int nTotal)
        {
            ...
            dt = new KoubaiDataSet.M_BuhinDataTable();
