...
namespace KoubaiDAL
{
    ...
    {
        public static void SaveM_Buhin(KoubaiDataSet.M_BuhinDataTable dt, DateTime torikomiBi, string fileName, SqlConnection sqlCon)
        {
            ...
            try
            {
                ...
                KoubaiDataSet.M_BuhinDataTable dtThis = new KoubaiDataSet.M_BuhinDataTable();
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    // ■アップロードファイルデータを保存
                    KoubaiDataSet.M_BuhinUploadDataTable dtUpload = new KoubaiDataSet.M_BuhinUploadDataTable();
                    KoubaiDataSet.M_BuhinUploadRow drUpload = dtUpload.NewM_BuhinUploadRow();
        ...
        public static void SaveT_Chumon(KoubaiDataSet.T_ChumonDataTable dt, string fileName, SqlConnection sqlCon)
        {
            DateTime now = DateTime.Now;
            ...
            try
            {
                ...
                // ■発注テーブルを更新
                KoubaiDataSet.T_ChumonDataTable dtChumonThis = new KoubaiDataSet.T_ChumonDataTable();

                KoubaiDataSet.T_ChumonUploadDataTable dtUpload = new KoubaiDataSet.T_ChumonUploadDataTable();
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    KoubaiDataSet.T_ChumonRow drChumonThis = dtChumonThis.NewT_ChumonRow();
                    ...
                    // ■ファイルデータをDBに保存
                    KoubaiDataSet.T_ChumonUploadRow drUpload = dtUpload.NewT_ChumonUploadRow();
