...
namespace KoubaiDAL
{
    public class KenshuClass
    {
        ...
        /// <param name="sqlConn"></param>
        /// <returns></returns>
        public static KenshuDataSet.V_KenshuDataTable getV_KenshuDataTable(string strKeyAry, SqlConnection sqlConn)
        {
            SqlDataAdapter da = new SqlDataAdapter("", sqlConn);
            da.SelectCommand.CommandText =
             "SELECT T_Nouhin.Year, T_Nouhin.HacchuuNo, T_Nouhin.NouhinNo, T_Nouhin.Suuryou AS NouhinSuuryou, "
        ...
        /// <param name="sqlConn"></param>
        /// <returns></returns>
        public static KenshuDataSet.V_KenshuDataTable getV_Kenshu_MeisaiDataTable(string strKeyAry, SqlConnection sqlConn)
        {
            SqlDataAdapter da = new SqlDataAdapter("", sqlConn);
            da.SelectCommand.CommandText =
            ...
            + "INNER JOIN M_Buhin ON T_Chumon.BuhinCode = M_Buhin.BuhinCode "
            + "INNER JOIN M_Shiiresaki ON T_Chumon.ShiiresakiCode = M_Shiiresaki.ShiiresakiCode "
            + "RIGHT OUTER JOIN T_Nouhin ON T_Chumon.Year = T_Nouhin.Year AND "
        ...
        /// <param name="sqlConn"></param>
        /// <returns></returns>
        public static KenshuDataSet.V_Kenshu_ShukeiDataTable getV_Kenshu_ShukeiDataTable(KensakuParam k, SqlConnection sqlConn)
        {
            SqlDataAdapter da = new SqlDataAdapter("", sqlConn);
            da.SelectCommand.CommandText =
            "SELECT TOP (100) PERCENT T_Nouhin.NouhinNo, T_Nouhin.Suuryou, T_Chumon.ShiiresakiCode, T_Nouhin.NouhinBi, "
            + "M_Shiiresaki.ShiiresakiMei, T_Chumon.Tanka ,T_Nouhin.Zeiritu "
            + "FROM dbo.T_Nouhin "
            + "INNER JOIN dbo.T_Chumon ON dbo.T_Nouhin.Year = dbo.T_Chumon.Year "
            + "AND dbo.T_Nouhin.HacchuuNo = dbo.T_Chumon.HacchuuNo "
            + "INNER JOIN dbo.M_Shiiresaki ON dbo.T_Chumon.ShiiresakiCode = dbo.M_Shiiresaki.ShiiresakiCode "
            + "INNER JOIN dbo.M_Buhin ON dbo.T_Chumon.BuhinCode = dbo.M_Buhin.BuhinCode "
            + "WHERE T_Chumon.CancelBi IS NULL ";
        ...
        /// <param name="sqlConn"></param>
        /// <returns></returns>
        public static KenshuDataSet.V_Kenshu_BuhinKubunDataTable V_Kenshu_BuhinKubunDataTable(SqlConnection sqlConn)
        {
            SqlDataAdapter da = new SqlDataAdapter("", sqlConn);
            da.SelectCommand.CommandText =
            ...
            + "FROM T_Chumon "
            + "INNER JOIN M_Buhin ON T_Chumon.BuhinCode = M_Buhin.BuhinCode "
            + "INNER JOIN T_Nouhin ON T_Chumon.Year = T_Nouhin.Year AND T_Chumon.HacchuuNo = T_Nouhin.HacchuuNo AND "
        ...
        /// <param name="sqlConn"></param>
        /// <returns></returns>
        public static KenshuDataSet.V_Kenshu_BuhinDataTable getV_Kenshu_BuhinDataTable(string strKubun, SqlConnection sqlConn)
        {
            SqlDataAdapter da = new SqlDataAdapter("", sqlConn);
            da.SelectCommand.CommandText =
            "SELECT DISTINCT TOP (100) PERCENT T_Chumon.BuhinCode, M_Buhin.BuhinMei, T_Chumon.BuhinKubun "
            + "FROM T_Chumon "
            + "INNER JOIN M_Buhin ON T_Chumon.BuhinCode = M_Buhin.BuhinCode AND "
            + "           T_Chumon.BuhinKubun = M_Buhin.BuhinKubun "
            + "INNER JOIN T_Nouhin ON T_Chumon.Year = T_Nouhin.Year AND T_Chumon.HacchuuNo = T_Nouhin.HacchuuNo AND "
            + "           T_Chumon.JigyoushoKubun = dbo.T_Nouhin.JigyoushoKubun "
        ...
        /// <param name="sqlConn"></param>
        /// <returns></returns>
        public static KenshuDataSet.V_Kenshu_ShiireDataTable getV_Kenshu_ShiireDataTable(SqlConnection sqlConn)
        {
            SqlDataAdapter da = new SqlDataAdapter("", sqlConn);
            da.SelectCommand.CommandText =
            "SELECT DISTINCT TOP (100) PERCENT T_Chumon.ShiiresakiCode, M_Shiiresaki.ShiiresakiMei "
            + "FROM M_Shiiresaki "
            + "INNER JOIN T_Chumon ON M_Shiiresaki.ShiiresakiCode = T_Chumon.ShiiresakiCode "
            + "INNER JOIN T_Nouhin ON T_Chumon.Year = T_Nouhin.Year AND T_Chumon.HacchuuNo = T_Nouhin.HacchuuNo AND "
            + "           T_Chumon.JigyoushoKubun = dbo.T_Nouhin.JigyoushoKubun "
            + "WHERE T_Chumon.CancelBi IS NULL "
        ...
        /// <param name="sqlConn"></param>
        /// <returns></returns>        
        public static KenshuDataSet.V_KenshuBindDataTable getV_KenshuBindDataTable(KensakuParam k, SqlConnection sqlConn)
        {
            SqlDataAdapter da = new SqlDataAdapter("", sqlConn);
            da.SelectCommand.CommandText =
        ...
        /// <param name="sqlConn"></param>
        /// <returns></returns>        
        public static KenshuDataSet.V_KenshuBindDataTable getV_KenshuBin2dDataTable(KensakuParam k, SqlConnection sqlConn)
        {
            SqlDataAdapter da = new SqlDataAdapter("", sqlConn);
            da.SelectCommand.CommandText =
              "SELECT T_Nouhin.Year, T_Nouhin.HacchuuNo, T_Nouhin.NouhinNo, T_Nouhin.Suuryou, T_Chumon.ShiiresakiCode, "
