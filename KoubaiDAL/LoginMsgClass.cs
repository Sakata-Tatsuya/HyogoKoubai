...
namespace KoubaiDAL
{
    public class LoginMsgClass
    {
        ...
        /// <returns></returns>
        public static KoubaiDataSet.M_LoginMsgDataTable getM_LoginMsgDataTable(SqlConnection sqlConn)
        {
            SqlDataAdapter da = new SqlDataAdapter("", sqlConn);
            da.SelectCommand.CommandText = "SELECT * FROM M_LoginMsg WHERE  DelFlg = 0 ";
            KoubaiDataSet.M_LoginMsgDataTable dt = new KoubaiDataSet.M_LoginMsgDataTable();
            da.Fill(dt);
            return dt;
        }

        public static KoubaiDataSet.M_LoginMsgDataTable getM_LoginMsgDataTable(KensakuParam k, SqlConnection sqlConn)
        {
            SqlDataAdapter da = new SqlDataAdapter("", sqlConn);
        ...
        /// <param name="sqlConn"></param>
        /// <returns></returns>
        public static KoubaiDataSet.M_LoginMsgDataTable getM_LoginMsg2DataTable(SqlConnection sqlConn)
        {
            SqlDataAdapter da = new SqlDataAdapter("", sqlConn);
            da.SelectCommand.CommandText = "SELECT * FROM M_LoginMsg ";
            KoubaiDataSet.M_LoginMsgDataTable dt = new KoubaiDataSet.M_LoginMsgDataTable();
        ...
        /// <param name="sqlConn"></param>
        /// <returns></returns>
        public static KoubaiDataSet.M_LoginMsgRow getM_LoginMsgRow(int MsgID, SqlConnection sqlConn)
        {
            SqlDataAdapter da = new SqlDataAdapter("", sqlConn);
            ...
            da.Fill(dt);
            if (1 == dt.Rows.Count)
                return (KoubaiDataSet.M_LoginMsgRow)dt.Rows[0];
            else
                return null;
        }
        ...
        /// <param name="sqlConn"></param>
        /// <returns></returns>
        public static LibError M_LoginMsg_Insert(KoubaiDataSet.M_LoginMsgRow dr, SqlConnection sqlConn)
        {
            SqlDataAdapter da = new SqlDataAdapter("", sqlConn);
            da.SelectCommand.CommandText = "SELECT * FROM M_LoginMsg";
         ...
         /// <param name="sqlConn"></param>
         /// <returns></returns>
        public static LibError M_LoginMsg_Update(int MsgID, KoubaiDataSet.M_LoginMsgRow dr, SqlConnection sqlConn)
        {
            SqlDataAdapter da = new SqlDataAdapter("", sqlConn);
            da.SelectCommand.CommandText = "SELECT * FROM M_LoginMsg WHERE MsgID = @MsgID";
            da.SelectCommand.Parameters.AddWithValue("@MsgID", MsgID);
            ...
            try
            {
                KoubaiDataSet.M_LoginMsgRow drThis = (KoubaiDataSet.M_LoginMsgRow)dt.Rows[0];
                drThis.Msg = dr.Msg;              
        ...
        /// </summary>
        /// <returns></returns>
        public static KoubaiDataSet.M_LoginMsgRow
            newM_LoginMsgRow()
        {
            return new KoubaiDataSet.M_LoginMsgDataTable().NewM_LoginMsgRow();
        }
    }
}
