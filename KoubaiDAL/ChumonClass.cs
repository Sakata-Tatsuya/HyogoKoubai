...
namespace KoubaiDAL
{
    public class ChumonClass
    {
        ...
        public static KoubaiDataSet.T_ChumonDataTable getT_ChumonDataTableByYear(string sYear, int nKanno ,SqlConnection sqlConn)
        {
            SqlDataAdapter da = new SqlDataAdapter("", sqlConn);
        ...
        /// <param name="sqlConn"></param>
        /// <returns></returns>
        public static LibError T_Chumon_Update_CancelBi(string Year, string HacchuuNo, int nJigyoushoKubun, KoubaiDataSet.T_ChumonRow dr, SqlConnection sqlConn)
        {
            SqlDataAdapter da = new SqlDataAdapter("", sqlConn);
            ...
            try
            {
                KoubaiDataSet.T_ChumonRow drThis = (KoubaiDataSet.T_ChumonRow)dt.Rows[0];
        ...
        public static LibError
            T_Chumon_Update(string Year, string HacchuuNo, int nJigyoushoKubun, KoubaiDataSet.T_ChumonRow dr, SqlConnection sqlConn)
        {
            SqlDataAdapter da = new SqlDataAdapter("", sqlConn);
            da.SelectCommand.CommandText = "SELECT * FROM T_Chumon WHERE Year = @Year AND HacchuuNo = @HacchuuNo AND JigyoushoKubun = @JigyoushoKubun ";
            da.SelectCommand.Parameters.AddWithValue("@Year", Year);
        ...
        /// <param name="sqlConn"></param>
        /// <returns></returns>
        public static KoubaiDataSet.T_ChumonDataTable getT_ChumonDataTable(SqlConnection sqlConn)
        {
            SqlDataAdapter da = new SqlDataAdapter("", sqlConn);
            da.SelectCommand.CommandText =
        ...
        /// </summary>
        /// <returns></returns>
        public static KoubaiDataSet.T_ChumonRow newT_ChumonRow()
        {
            return new KoubaiDataSet.T_ChumonDataTable().NewT_ChumonRow();
        }
        ...
        /// <returns></returns>
        /// 追加 09/07/23
        public static KoubaiDataSet.T_ChumonRow getT_ChumonRow(string Year, string HacchuuNo, int nJigyoushoKubun, SqlConnection sqlConn)
        {
            SqlDataAdapter da = new SqlDataAdapter("", sqlConn);
            da.SelectCommand.CommandText =
            ...
            da.Fill(dt);
            if (1 == dt.Rows.Count)
                return (KoubaiDataSet.T_ChumonRow)dt.Rows[0];
            else
                return null;
        }
        ...
        /// <returns></returns>
        /// 追加 09/07/23
        public static LibError T_Chumon_Update_Kannou(string Year, string HacchuuNo, int nJigyoushoKubun, KoubaiDataSet.T_ChumonRow dr, SqlConnection sqlConn)
        {
            SqlDataAdapter da = new SqlDataAdapter("", sqlConn);
            da.SelectCommand.CommandText = "SELECT * FROM T_Chumon WHERE Year = @Year AND HacchuuNo = @HacchuuNo  AND JigyoushoKubun = @JigyoushoKubun ";
            da.SelectCommand.Parameters.AddWithValue("@Year", Year);
       ...
       private static string WhereKey2(string strAry)
       {
        ...
        public static LibError T_Chumon_Insert(KoubaiDataSet.T_ChumonDataTable dtOrder, SqlConnection sqlConn)
        {
            SqlDataAdapter da = new SqlDataAdapter("", sqlConn);
            da.SelectCommand.CommandText = "SELECT * FROM T_Chumon";
            ...
            try
            {
                ...
                {
                    KoubaiDataSet.T_ChumonRow drNew = dt.NewT_ChumonRow();
                    nOrderNo++;
