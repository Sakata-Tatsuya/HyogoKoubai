...
namespace KoubaiDAL
{
    ...
    {
        private const string _SystemURL = "http://Koubai.m2m-asp.com/";
        /// <summary>
        /// メール送信時に必要な項目
        ...
        /// </summary>
        /// <returns></returns>
        public static string GetBody_KaishaInfo_Koushin(ChumonDataSet.V_Chumon_MailRow dr, KoubaiDataSet.M_ShiiresakiRow drShiire)
        {
            string strBody =
             "会社情報が更新されました。\r\n"
             + "下記URLにログインいただき、内容のご確認をお願い致します。\r\n"
        ...
        /// </summary>
        /// <returns></returns>
        public static string GetBody_NoukiKaitou_Shinki(KoubaiDataSet.M_ShiiresakiRow dr)
        {
            string strBody =
              "納期回答が登録されました。\r\n"
              + "下記URLにログインいただき、内容のご確認をお願い致します。\r\n"
        ...
        /// </summary>
        /// <returns></returns>
        public static string GetBody_NoukiKaitou_Koushin(KoubaiDataSet.M_ShiiresakiRow dr)
        {
            string strBody =
              "納期回答が変更されました。\r\n"
              + "下記URLにログインいただき、内容のご確認をお願い致します。\r\n"
