...
namespace KoubaiDAL
{
    public class NouhinClass
    {
        ...
        public static KoubaiDataSet.T_NouhinDataTable getT_NouhinDataTable(string Year, string HacchuuNo, int nKubun, SqlConnection sqlConn)
        {
            ...
            KoubaiDataSet.T_NouhinDataTable dt = new KoubaiDataSet.T_NouhinDataTable();
            da.Fill(dt);
            return dt;
        }
        ...
        public static LibError T_Nouhin_Insert_T_Chumon_Update
            (KoubaiDataSet.T_NouhinRow drNouhin, KoubaiDataSet.T_ChumonRow drChumon,
            string Year, string HacchuuNo, int nKubun, int nRowNo, bool kannouFlg, string TourokuUser, SqlConnection sqlConn)
        {
            ...
            KoubaiDataSet.T_NouhinDataTable dtN = new KoubaiDataSet.T_NouhinDataTable();
            KoubaiDataSet.T_NouhinRow drNew = dtN.NewT_NouhinRow();
            ...
            try
            {
                ...
                if ((dtNs[0].SuryouSum + drNew.Suuryou) == dtC[0].Suuryou || kannouFlg)
                {
                    ...
                    try
                    {
                        KoubaiDataSet.T_ChumonRow drThis = (KoubaiDataSet.T_ChumonRow)dtC.Rows[0];
        ...
        /// </summary>
        /// <returns></returns>
        public static KoubaiDataSet.T_NouhinRow
            newT_NouhinRow()
        {
            return new KoubaiDataSet.T_NouhinDataTable().NewT_NouhinRow();
        }
