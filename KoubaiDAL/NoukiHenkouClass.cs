...
namespace KoubaiDAL
{
    ...
    {
        public static KoubaiDataSet.T_NoukiHenkouDataTable getT_NoukiHenkouDataTable(SqlConnection sqlConn)
        {
            SqlDataAdapter da = new SqlDataAdapter("", sqlConn);
            da.SelectCommand.CommandText = "SELECT * FROM T_NoukiHenkou";
            KoubaiDataSet.T_NoukiHenkouDataTable dt = new KoubaiDataSet.T_NoukiHenkouDataTable();
            da.Fill(dt);
            return dt;
        }
        ...
        /// <returns></returns>
        public static KoubaiDataSet.T_NoukiHenkouDataTable getT_NoukiHenkouDataTable(string Year, string HacchuuNo, int nKubun, SqlConnection sqlConn)
        {
            SqlDataAdapter da = new SqlDataAdapter("", sqlConn);
        ...
        public static KoubaiDataSet.T_NoukiHenkouRow newT_NoukiHenkouRow()
        {
            return new KoubaiDataSet.T_NoukiHenkouDataTable().NewT_NoukiHenkouRow();
        }
        ...
        /// <param name="sqlConn"></param>
        /// <returns></returns>
        public static KoubaiDataSet.T_NoukiHenkouDataTable getT_NoukiHenkouDataTable(string strYear, string strNo, int nKubun, int nNo, SqlConnection sqlConn)
        {
            SqlDataAdapter da = new SqlDataAdapter("", sqlConn);
        ...
        public static LibError T_NoukiHenkou_Update(string year, string no, int nKubun, int nhenkouNo, string LoginID, SqlConnection sqlConn)
        {
            ...
            KoubaiDataSet.T_NoukiHenkouDataTable dtNew = new KoubaiDataSet.T_NoukiHenkouDataTable();
            da.Fill(dtNew);
            try
            {
                for (int i = 0; i < dtNew.Rows.Count; i++)
                {
                    KoubaiDataSet.T_NoukiHenkouRow dr = dtNew.Rows[i] as KoubaiDataSet.T_NoukiHenkouRow;
                    dr.ShouninFlg = true;
                               ...
                               Hashtable NoukiHenkouDataTbl, int nHenkouNo, SqlConnection sqlConn)
        {
            ...
            int nRowNo = 1;
                ...
                KoubaiDataSet.T_ChumonDataTable dtC = new KoubaiDataSet.T_ChumonDataTable();
                daC.Fill(dtC);
                if (dtC.Rows.Count != 1)
                {
                ...
                try
                {
                    ...
                    KoubaiDataSet.T_NoukiHenkouDataTable dtHenkouNoukiIns = new KoubaiDataSet.T_NoukiHenkouDataTable();
                    ...
                    {
                        KoubaiDataSet.T_NoukiHenkouRow drHenkouNoukiIns =
